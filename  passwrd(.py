...
try:
    url_proxy = random.choice([
              "https://raw.githubusercontent.com/TheSpeedX/SOCKS-List/master/socks5.txthttps://raw.githubusercontent.com/TheSpeedX/SOCKS-List/master/socks4.txt -o socks4.txt",
])
    url_proxy = random.choice([
...
def menu(my_name,my_id):	
	...
	banner()
	print(f"\x1b[1;97m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
	print(f"\x1b[1;94m ¤_𝐓𝐞𝐥𝐞𝐠𝐫𝐚𝐦 : @OP3PP ")
	print(f"\x1b[1;97m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
	print('\n    [\x1b[1;97m\x1b[1;41m     𝐌𝐄𝐍𝗨 V3\x1b[0m\x1b[1;93m]\n')
	print(47*'\033[1;31m▬\033[1;37m')
	print(f'𝐘ⱺυ𝗋 𝚰𝐃 : '+str(my_id))
	print(f'𝐘ⱺυ𝗋 𝚰𝐏 : {ip}')
	print('{\033[2;32m𝟏}\033[2;36m 𝐂𝐑𝐀𝐂𝐊 𝐏𝐔𝐁𝐋𝚰𝐂 ')
	print('{\033[2;32m𝟐}\033[2;36m 𝐂𝐑𝐀𝐂𝐊 𝐅𝚰𝐋𝐄 ')		
	print('{\033[2;32m𝟎}\033[2;36m 𝐋𝐨𝐠𝐢𝐧 𝐨𝐮𝐭 ')
	print(47*'\033[1;31m▬\033[1;37m')
...
def TakeFile():
	...
	try:
		...
		jum = input('\033[97;1m[\033[92;1m+\033[97;1m] FILE NAME :\033[92;1m ')
...
def setting():
	print(f'{H}𝟏 - 𝐑𝐀𝐍𝐃𝐎𝐌')
	hu = input('\x1b[1;92m𝐂𝐡𝐨𝐨𝐬𝐞 : \x1b[1;97m')
	if hu in ['1','01']:
	...
	if hc in ['1','01']:
		...
		method.append('mobile')
	pwplus=input('\x1b[1;91m- Y - 𝐌𝐀𝐍𝐔𝐀𝐋 𝐏𝐀𝐒𝐒𝐒𝐒\x1b[1;96m                                                     \x1b[1;92m- T - 𝐀𝐔𝐓𝐎 𝐏𝐀𝐒𝐒𝐒\x1b[1;92m\n\x1b[1;96m𝐂𝐡𝐨𝐨𝐬𝐞 : \x1b[1;97m')
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
...
def passwrd():
	print(f"\x1b[1;97m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
	print(f"\x1b[1;94m صور صيدك ياعزيزي ")
	print(f"\x1b[1;97m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
...
def crack(idf,pwv):
	...
	fff = '%'
	print('\r%s ⚜️ ABAS ⚜️%s/%s • 𝐎𝐊   %s •  𝐶𝑃   %s • %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
